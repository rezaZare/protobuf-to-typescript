        ...
        while (i < todo.length) {
            ...
            if (placeholder instanceof Node) {
                ...
                for (let j = 0; j < array.length; j++) {
                    ...
                    if (maybeImp instanceof ImportsName &&
                    ...
                    else if (maybeImp instanceof ImportsName &&
                    ...
                    else if (maybeImp instanceof ImportsDefault &&
                        forceModuleImport.includes(maybeImp.source)) {
...
export function deepGenerate(used, object) {
    let result = "";
    let todo = [object];
    let i = 0;
    while (i < todo.length) {

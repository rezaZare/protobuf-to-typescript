...
export async function saveFiles(opts: SaveFilesOpts): Promise<void> {
  ...
  //         const hash = sha1(
  //           contentToString(file, { ...toStringOpts, format: false })
  //         );
  //         if (exists) {
  ...
  //         const pad =
  //           lengthLength !== String(initialLength + lengthLength).length
  //             ? 1
  //             : 0;
  //         await fs.writeFile(
  //           path,
  //           prefix + String(initialLength + lengthLength + pad) + suffix
  //         );
  //       }
  //     } else if (!exists) {

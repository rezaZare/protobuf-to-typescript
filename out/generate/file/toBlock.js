...
function fileToBlock(root, grpcPath, outPath) {
    var _a;
    return __awaiter(this, void 0, void 0, function () {
        var result, directorys, _i, directorys_1, dirent, isDirectory, nestedDirectory, codeBlocks, imports, pathResolved, data, parsed;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, fileToBlock(root + "/" + dirent.name, grpcPath + "/" + dirent.name, outPath + "/" + dirent.name)];
                case 3:
                ...
                case 5:
                    ...
                    if (data) {
                        ...
                        if (((_a = parsed.imports) === null || _a === void 0 ? void 0 : _a.length) > 0) {
                            imports = generateImportCode_1.generateImportCode(parsed.imports);
                        }
                    }
                    return [4 /*yield*/, getCodeBlocks(pathResolved, imports)];
                case 6:
                    codeBlocks = _b.sent();
                    _b.label = 7;
                case 7:
...
function getCodeBlocks(filePath, imports) {
    return __awaiter(this, void 0, void 0, function () {
        var loadedProto;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (loadedProto) {
                        debugger;
                        return [2 /*return*/, generateTypes_1.generateTypes(loadedProto, imports)];
                    }

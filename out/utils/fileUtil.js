...
var FileUtil = /** @class */ (function () {
    ...
    FileUtil.prototype.write = function (files) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _i, files_1, file, _codes, imported, serviceTypeCode, codes;
                ...
                switch (_d.label) {
                    ...
                    case 2:
                        ...
                        if (((_b = (_a = file.importFiles) === null || _a === void 0 ? void 0 : _a.imports) === null || _b === void 0 ? void 0 : _b.length) > 0) {
                            imported = generateImport((_c = file.importFiles) === null || _c === void 0 ? void 0 : _c.imports);
                            _codes.push.apply(_codes, imported);
                        }
                        _codes.push.apply(_codes, getCode(file.codeBlock, file));

...
var FileIo = /** @class */ (function () {
    ...
    FileIo.loadProtobuf = function (filePath) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    FileIo.prototype.write = function (files, model) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var _i, files_1, file, _codes, fileCode, codes;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        file = files_1[_i];
                        if (!(((_a = file.nested) === null || _a === void 0 ? void 0 : _a.length) > 0)) return [3 /*break*/, 2];
                        this.write(file.nested, model);
                        return [3 /*break*/, 4];
                    case 2:
                        _codes = [];
                        fileCode = file.getCode();
                        _codes.push.apply(_codes, fileCode);
                        codes = _codes.join("\n");
                        if (!codes) return [3 /*break*/, 4];
                        return [4 /*yield*/, writeUtil.sync(file.pathInfo.outPath, codes, {
                                newline: true,
                                overwrite: true,
                            })];
                    case 3:
    ...
    FileIo.prototype.writeGlobalFiles = function (model, path) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:

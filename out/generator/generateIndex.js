...
function generateIndex(root) {
    return __awaiter(this, void 0, void 0, function () {
        var indexPath, indexTypePath, pathParse, directorys, content, _i, directorys_1, file;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    indexPath = root + "/index.ts";
                    indexTypePath = root + "/index.d.ts";
                    pathParse = path.parse(root);
                    if (!(pathParse.name !== "global")) return [3 /*break*/, 11];

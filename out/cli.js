            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (argv["name"] &&
                        ...
                        console.log("Starting ... ", "packageName: " + argv["name"], "proto-dir: " + argv["proto-dir"], "output-dir: " + argv["output-dir"], "endpoint: " + argv["endpoint"], "unauthorized-path: " + argv["unauthorized-path"]);
                        (0, index_1.protoToTs)(argv["name"], argv["proto-dir"], argv["output-dir"], argv["endpoint"], argv["unauthorized-path"]);
                    }
                    return [3 /*break*/, 3];
                case 2:
                    error_1 = _a.sent();
